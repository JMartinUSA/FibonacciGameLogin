...
function logout(){
	...
	xhttp.open("GET", "http://jaymartmedia.com/fibonacci/logout.php?ID="+ID, true);
	xhttp.send();
...
function login(){
	...
	if(document.getElementsByClassName('loginCover').length > 0){
		...
		if( username != '' && password != '' ){	
			...
			xhttp.open("GET", "http://jaymartmedia.com/fibonacci/login.php?USERNAME="+username+"&PASSWORD="+password, true);
			xhttp.send();
...
function doLogin(){
	...
	xhttp.open("GET", "http://jaymartmedia.com/fibonacci/confirm.php?USERNAME="+USERNAME, true);
	xhttp.send();
	...
	function sendPHP(ID){
		...
		console.log('ID: '+ID);
		xhttp2.open("GET", "http://jaymartmedia.com/fibonacci/fibonacci.php?ID="+ID, true);
		xhttp2.send();
		...
		console.log('ID: '+ID);
		xhttp3.open("GET", "http://jaymartmedia.com/fibonacci/correctincorrect.php?ID="+ID, true);
		xhttp3.send();
...
function register(){
	...
	if( error.length == 0 ){
		...
		xhttp.open("GET", "http://jaymartmedia.com/fibonacci/register.php?USERNAME="+username+"&PASSWORD="+password+"&EMAIL="+email, true);
		xhttp.send();
	}
	function doPHP(receivePHP){
